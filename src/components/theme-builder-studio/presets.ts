...
function paletteParams(themeKey: keyof typeof CHART_PALETTES, mode: Mode): StudioParamMap {
    ...
    colors.forEach((color, i) => {
        ...
        out[`chartPaletteStrokes${i + 1}Color`] = color;
    });
    return out;
}
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#2E6BC6',
                    chromeBackgroundColor: '#E8EDF3',
                    borderColor: '#C8D3E0',
                    headerBackgroundColor: '#DDE4ED',
                    textColor: '#1A2B42',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#4A90E2',
                    chromeBackgroundColor: '#162438',
                    borderColor: '#1E3250',
                    headerBackgroundColor: '#1A2D45',
                    textColor: '#C8D8EC',
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#2D7A50',
                    chromeBackgroundColor: '#E4EDE6',
                    borderColor: '#C2D5C8',
                    headerBackgroundColor: '#D6E6DA',
                    textColor: '#1C3326',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#3DB06F',
                    chromeBackgroundColor: '#162A1F',
                    borderColor: '#1E3D2C',
                    headerBackgroundColor: '#1A3326',
                    textColor: '#B8D4C4',
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#8B6834',
                    chromeBackgroundColor: '#EDEAE4',
                    borderColor: '#E4E0D8',
                    headerBackgroundColor: '#EDEAE4',
                    textColor: '#3C3836',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#C49352',
                    chromeBackgroundColor: '#262320',
                    borderColor: '#3A3632',
                    headerBackgroundColor: '#262320',
                    textColor: '#D4CFC7',
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#0078D4',
                    chromeBackgroundColor: '#DCEAF5',
                    borderColor: '#BCCFE0',
                    headerBackgroundColor: '#CFE1F0',
                    textColor: '#2A3F55',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#3CA5F5',
                    chromeBackgroundColor: '#111F2E',
                    borderColor: '#1A3048',
                    headerBackgroundColor: '#15283B',
                    textColor: '#B0C8DD',
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#E05225',
                    chromeBackgroundColor: '#E8E8E5',
                    borderColor: '#D0D0CC',
                    headerBackgroundColor: '#DDDDD9',
                    textColor: '#2C2C2C',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#F06840',
                    chromeBackgroundColor: '#1E1E1E',
                    borderColor: '#333330',
                    headerBackgroundColor: '#282825',
                    textColor: '#CCCCC8',
        ...
        variants: {
            light: {
                ...
                params: {
                    ...
                    accentColor: '#7B3FA0',
                    chromeBackgroundColor: '#ECE4F2',
                    borderColor: '#D4C6DE',
                    headerBackgroundColor: '#E2D8EC',
                    textColor: '#2D1F3D',
            ...
            dark: {
                ...
                params: {
                    ...
                    accentColor: '#A65CD0',
                    chromeBackgroundColor: '#1C1428',
                    borderColor: '#2E2240',
                    headerBackgroundColor: '#241A32',
                    textColor: '#C8B8D8',
